...
export const TEXTS = {
  tripsList: {
    ...
    emptyTitle: "Ready for Your Next Adventure?",
    emptyBody:
  ...
  tripForm: {
    ...
    timezonePlaceholderNoCountry: "Select a country first",
    ...
    imageUrlLabel: "Trip Image URL (optional)",
    imageUrlPlaceholder: "https://example.com/trip-photo.jpg",
    dateError: "End date must be after start date",
    submitCreate: "Create Trip",
    submitEdit: "Update Trip",
  },
  budgetItemForm: {
    titleLabel: "Title",
