...
export function updateBudgetItemTime(tripId: string, id: string, newDate: string | null) {
  return apiClient.put<BudgetItem>(`/trips/${tripId}/budget-items/${id}`, { date: newDate });
}
